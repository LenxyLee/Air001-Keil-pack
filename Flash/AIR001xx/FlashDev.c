 ...
 * $Revision:    V1.0.0
 *
 * Project:      Flash Device Description for AirM2M AIR001xx Flash
 * --------------------------------------------------------------------------- */
...
struct FlashDevice const FlashDevice  =
{
  ...
  "AIR001xx 8kB Flash",       // Device Name (8kB)
  ONCHIP,                     // Device Type
...
{
  FLASH_DRV_VERS,             // Driver Version, do not modify!
  "AIR001xx 16kB Flash",      // Device Name (16kB)
  ONCHIP,                     // Device Type
  0x08000000,                 // Device Start Address
...
{
  FLASH_DRV_VERS,             // Driver Version, do not modify!
  "AIR001xx 20kB Flash",      // Device Name (20kB)
  ONCHIP,                     // Device Type
  0x08000000,                 // Device Start Address
...
{
  FLASH_DRV_VERS,             // Driver Version, do not modify!
  "AIR001xx 32kB Flash",      // Device Name (32kB)
  ONCHIP,                     // Device Type
  0x08000000,                 // Device Start Address
...
{
  FLASH_DRV_VERS,             // Driver Version, do not modify!
  "AIR001xx 48kB Flash",      // Device Name (48kB)
  ONCHIP,                     // Device Type
  0x08000000,                 // Device Start Address
...
{
  FLASH_DRV_VERS,             // Driver Version, do not modify!
  "AIR001xx 64kB Flash",      // Device Name (64kB)
  ONCHIP,                     // Device Type
  0x08000000,                 // Device Start Address
...
{
  FLASH_DRV_VERS,                     // Driver Version, do not modify!
  "AIR001xx Flash Options",           // Device Name
  ONCHIP,                             // Device Type
